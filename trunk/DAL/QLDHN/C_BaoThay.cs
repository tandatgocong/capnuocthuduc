...
namespace CAPNUOCTHUDUC.DAL.QLDHN
{
     public static class C_BaoThay
    {
        ...
        public static DataTable getBangKeBaoThay(int sobangke) {
            ...
            sql += " FROM TB_THAYDHN thay,TB_DULIEUKHACHHANG kh WHERE kh.DANHBO=thay.DHN_DANHBO AND DHN_SOBANGKE='" + sobangke + "'  ORDER BY kh.LOTRINH ASC ";
        ...
        public static DataSet ReportBaoThay(string sobangke)
        {
            ...
            db.Connection.Open();
            string query = "select *, N'' as 'TENDANGNHAP' FROM V_DHN_BANGKE where DHN_SOBANGKE='" + sobangke + "' ORDER BY TENBANGKE ASC ";
        ...
        public static TB_THAYDHN finByBaoThay(int sobangke, string danhbo)
        {
            ...
            {
                db = new ThuDucDataContext();
                var query = from q in db.TB_THAYDHNs where q.DHN_SOBANGKE == sobangke && q.DHN_DANHBO == danhbo  && q.DHN_LOAIBANGKE == "DK" orderby q.DHN_SOBANGKE descending select q;
